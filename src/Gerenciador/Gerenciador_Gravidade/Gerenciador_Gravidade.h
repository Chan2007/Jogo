...
namespace Gerenciadores {
    class Gerenciador_Gravidade {
        ...
        public:
            ...
            void setVelocidadeTerminal(const float velocidade) {vyTerminal = velocidade;}
            void setForcaPulo(const float forca) {forcaPulo = forca;}
            void setAtrito(const float a) {atrito = a;}
