...
#include <vector>
#include "Jogo_Principal/Sistema/Fisica/Mediador_Gravidade.h"
...
namespace Gerenciadores {
    class Gerenciador_Gravidade: public Mediador_Gravidade {
        ...
        public:
            ...
            bool estaNoChao(Entidades::Entidade* entidade) const;
            void aplicarAtrito(Entidades::Entidade* entidade, float dt);
