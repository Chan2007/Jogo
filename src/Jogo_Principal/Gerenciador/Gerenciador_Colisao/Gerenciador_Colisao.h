...
namespace Gerenciadores {
    ...
    class Gerenciador_Colisao: public Mediador_Colisao {
        private:
            ...
            static bool verificarLimitesJanela(Entidades::Entidade* entidade, Gerenciadores::Gerenciador_Gravidade* pGravidade = nullptr);
        public:
            ...
            void executar(Entidades::Entidade* entidade, Gerenciadores::Gerenciador_Gravidade* pGravidade = nullptr);
    };
} // Gerenciador
