...
std::string Encontrar_Diretorio::concatenarEnderecos(const std::string &left, const std::string &right) {
...
std::string Encontrar_Diretorio::acharDiretorio_Arquivo(const std::string &FileDirectory) {
